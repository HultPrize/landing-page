  ...
  return (
    <main className="min-h-screen w-full flex flex-col justify-center items-center px-8 md:px-16 lg:px-32 mt-16 py-16">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4">Fase 3</h1>
        <p className="text-2xl font-medium text-gray-700">
          Estrategia de Lanzamiento y Validación Final
        </p>
        <div className="mt-8">
          <p className="text-lg text-gray-600">
            10 de Enero, 2025 - 22 de Enero, 2025
          </p>
        </div>
      </div>
      <img
        src={`https://hult-prize.s3.us-east-1.amazonaws.com/HultPrize/photos/hultprize-epn-2022-2023-finals.jpeg`}
        alt={`Finales 2023-2024`}
